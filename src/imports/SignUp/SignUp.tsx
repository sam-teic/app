import svgPaths from "./svg-psfudq978v";
...
function Frame3() {
  return (
    <div className="bg-[rgba(128,128,128,0.04)] h-[56px] relative rounded-[32px] shrink-0 w-full">
      <div aria-hidden="true" className="absolute border border-[rgba(0,0,0,0.2)] border-solid inset-0 pointer-events-none rounded-[32px]" />
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex gap-[24px] items-center px-[24px] py-[16px] relative size-full">
          ...
          <p className="[word-break:break-word] font-['Public_Sans:Regular',sans-serif] font-normal leading-[1.4] relative shrink-0 text-[16px] text-[rgba(21,20,20,0.4)] text-center whitespace-nowrap">Phone Number</p>
        </div>
      </div>
    </div>
  );
...
function VuesaxLinearUser() {
  return (
    <div className="absolute contents inset-0" data-name="vuesax/linear/user">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20 20">
        <g id="user">
          <path d={svgPaths.p1039200} id="Vector" stroke="var(--stroke-0, #F70003)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
...
function Frame9() {
  return (
    <div className="bg-[rgba(128,128,128,0.04)] h-[56px] relative rounded-[32px] shrink-0 w-full">
      ...
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex gap-[24px] items-center px-[24px] py-[16px] relative size-full">
          <div className="relative shrink-0 size-[20px]" data-name="vuesax/linear/user">
            <VuesaxLinearUser />
          </div>
          <p className="[word-break:break-word] font-['Public_Sans:Regular',sans-serif] font-normal leading-[1.4] relative shrink-0 text-[16px] text-[rgba(21,20,20,0.4)] text-center whitespace-nowrap">Full Name</p>
        </div>
      </div>
    </div>
  );
    ...
    <div className="bg-[rgba(128,128,128,0.04)] h-[56px] relative rounded-[32px] shrink-0 w-full">
      ...
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex gap-[24px] items-center px-[24px] py-[16px] relative size-full">
          ...
          <p className="[word-break:break-word] font-['Public_Sans:Regular',sans-serif] font-normal leading-[1.4] relative shrink-0 text-[16px] text-[rgba(21,20,20,0.4)] text-center whitespace-nowrap">Email (optional)</p>
        </div>
      </div>
    </div>
  );
...
function VuesaxLinearArrowDown() {
  return (
    <div className="absolute contents inset-0" data-name="vuesax/linear/arrow-down">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20 20">
        <g id="arrow-down">
          <path d={svgPaths.p1134a680} id="Vector" stroke="var(--stroke-0, #94A3B8)" strokeLinecap="round" strokeLinejoin="round" strokeMiterlimit="10" strokeWidth="1.5" />
          <g id="Vector_2" opacity="0" />
        </g>
      </svg>
    </div>
    ...
    <div className="bg-[rgba(128,128,128,0.04)] h-[56px] relative rounded-[32px] shrink-0 w-full">
      ...
      <div className="flex flex-row items-center justify-center size-full">
        <div className="content-stretch flex items-center justify-between px-[24px] py-[16px] relative size-full">
          <p className="[word-break:break-word] font-['Public_Sans:Regular',sans-serif] font-normal leading-[1.4] relative shrink-0 text-[16px] text-[rgba(21,20,20,0.4)] text-center whitespace-nowrap">Select Provider</p>
...
function Frame8() {
  return (
    <div className="bg-[rgba(128,128,128,0.04)] h-[56px] relative rounded-[32px] shrink-0 w-full">
      ...
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex gap-[24px] items-center px-[24px] py-[16px] relative size-full">
          <div className="relative shrink-0 size-[20px]" data-name="vuesax/linear/calculator">
            <VuesaxLinearCalculator />
          </div>
          <p className="[word-break:break-word] font-['Public_Sans:Regular',sans-serif] font-normal leading-[1.4] relative shrink-0 text-[16px] text-[rgba(21,20,20,0.4)] text-center whitespace-nowrap">Meter Number</p>
        </div>
      </div>
    </div>
  );
...
function VuesaxLinearLock() {
  return (
    <div className="absolute contents inset-0" data-name="vuesax/linear/lock">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20 20">
        <g id="lock">
          <path d={svgPaths.pe9cbd00} id="Vector" stroke="var(--stroke-0, #F70003)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
          <path d={svgPaths.pdeff500} id="Vector_2" stroke="var(--stroke-0, #F70003)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
          <path d={svgPaths.p360c6800} id="Vector_3" stroke="var(--stroke-0, #F70003)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
...
function VuesaxLinearEye() {
  return (
    <div className="absolute contents inset-0" data-name="vuesax/linear/eye">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20 20">
        <g id="eye">
          <path d={svgPaths.p3e60be40} id="Vector" stroke="var(--stroke-0, #94A3B8)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
          <path d={svgPaths.p235b8f00} id="Vector_2" stroke="var(--stroke-0, #94A3B8)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
          <g id="Vector_3" opacity="0" />
        </g>
      </svg>
    </div>
...
function Frame4() {
  return (
    <div className="bg-[rgba(128,128,128,0.04)] h-[56px] relative rounded-[32px] shrink-0 w-full">
      ...
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex gap-[24px] items-center px-[24px] py-[16px] relative size-full">
          <div className="relative shrink-0 size-[20px]" data-name="vuesax/linear/lock">
            <VuesaxLinearLock />
          </div>
          <p className="[word-break:break-word] font-['Public_Sans:Regular',sans-serif] font-normal leading-[1.4] relative shrink-0 text-[16px] text-[rgba(21,20,20,0.4)] text-center whitespace-nowrap">Password</p>
          <div className="absolute left-[348px] size-[20px] top-[18px]" data-name="vuesax">
            <VuesaxLinearEye />
          </div>
        </div>
      </div>
    ...
    <div className="bg-[rgba(128,128,128,0.04)] h-[56px] relative rounded-[32px] shrink-0 w-full">
      ...
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex gap-[24px] items-center px-[24px] py-[16px] relative size-full">
          ...
          <p className="[word-break:break-word] font-['Public_Sans:Regular',sans-serif] font-normal leading-[1.4] relative shrink-0 text-[16px] text-[rgba(21,20,20,0.4)] text-center whitespace-nowrap">Confirm Password</p>
          <div className="absolute left-[348px] size-[20px] top-[18px]" data-name="vuesax">
            <VuesaxLinearEye1 />
          </div>
        </div>
...
function Frame() {
  return (
    <div className="-translate-x-1/2 absolute content-stretch flex flex-col gap-[20px] items-start left-1/2 top-[208px] w-[392px]">
      <Frame3 />
      <Frame9 />
      <Frame10 />
      <Frame7 />
...
function Frame2() {
  return (
    <div className="bg-[#f70003] relative rounded-[32px] shrink-0 w-full">
      <div className="flex flex-row items-center justify-center size-full">
        <div className="content-stretch flex items-center justify-center px-[32px] py-[16px] relative size-full">
          <p className="[word-break:break-word] font-['Public_Sans:Regular',sans-serif] font-normal leading-[1.4] relative shrink-0 text-[18px] text-center text-white whitespace-nowrap">Sign up</p>
        </div>
      </div>
    </div>
  );
...
function Frame12() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[20px] items-center justify-center left-[19px] top-[774px] w-[397px]">
      <Frame2 />
      <div className="[word-break:break-word] flex flex-col font-['Poppins:Regular',sans-serif] h-[20px] justify-center leading-[0] not-italic relative shrink-0 text-[#64748b] text-[14px] text-center w-[268.27px]">
        <p>
          <span className="leading-[20px]">{`Already have an account? `}</span>
          <span className="[word-break:break-word] font-['Poppins:SemiBold',sans-serif] leading-[20px] not-italic text-[#f70003]">Login</span>
        </p>
      </div>
    </div>
  );
...
export default function SignUp() {
  return (
    <div className="bg-[#f8f9fa] relative size-full" data-name="Sign up">
      <StatusbarIPhoneXLightBackground />
      <Frame />
      <Frame12 />
      <p className="[word-break:break-word] absolute font-['Public_Sans:SemiBold',sans-serif] font-semibold leading-[1.32] left-[calc(37.5%-141px)] text-[#373737] text-[36px] top-[128px] whitespace-nowrap">Create an Account</p>
      <ArrowLeft />
    </div>
  );
}