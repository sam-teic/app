import svgPaths from "./svg-c7qk27anb7";
...
function Heading1() {
  return (
    <div className="[word-break:break-word] content-stretch flex gap-[2px] items-baseline leading-[0] relative shrink-0 tracking-[-0.96px] w-full whitespace-nowrap" data-name="Heading 2">
      <div className="flex flex-col font-['Public_Sans:SemiBold',sans-serif] font-semibold justify-center opacity-60 relative shrink-0 text-[#191c1e] text-[20px]">
        <p className="leading-[28px]">₦</p>
      </div>
      <div className="flex flex-col font-['Public_Sans:Bold',sans-serif] font-bold justify-center relative shrink-0 text-[#191c1e] text-[32px]">
        <p className="leading-[56px]">12,500</p>
      </div>
      <div className="flex flex-col font-['Public_Sans:Regular',sans-serif] font-normal justify-center relative shrink-0 text-[#5f5e5e] text-[14px]">
...
function Container5() {
  return (
    <div className="content-stretch flex flex-col gap-[3.5px] items-start relative shrink-0 w-[137.35px]" data-name="Container">
      <Container6 />
      <Heading1 />
    </div>
  );
...
function Overlay3() {
  return (
    <div className="bg-[rgba(255,218,212,0.2)] content-stretch flex items-center justify-center relative rounded-[9999px] shrink-0 size-[40px]" data-name="Overlay">
      <Container24 />
    </div>
  );
}
  ...
  return (
    <div className="relative shrink-0 size-[32px]" data-name="SVG">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 32 32">
        <g id="SVG">
          <path d="M8 24L24 8M8 8L24 24" id="Vector" stroke="var(--stroke-0, #F70003)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="3.33333" />
        </g>
      </svg>
    </div>
  );
...
function Button5() {
  return (
    <div className="absolute bg-[#fee2e2] content-stretch flex items-center justify-center left-0 overflow-clip rounded-[32px] shadow-[0px_16px_16px_-8px_rgba(0,0,0,0.32)] size-[56px] top-0" data-name="Button">
  ...
  return (
    <div className="h-[16px] relative shrink-0 w-[20px]" data-name="Container">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20 16">
        <g id="Container">
          <path d={svgPaths.p6e9f800} fill="var(--fill-0, white)" id="Icon" />
        </g>
      </svg>
    </div>
  );
...
function Container34() {
  return (
    <div className="content-stretch flex flex-col items-center relative shrink-0" data-name="Container">
      <div className="[word-break:break-word] flex flex-col font-['Public_Sans:SemiBold',sans-serif] font-semibold justify-center leading-[0] relative shrink-0 text-[14px] text-center text-white whitespace-nowrap">
        <p className="leading-[20px]">Create Wallet</p>
      </div>
    </div>
  );
}
...
function Button5CreateWallet() {
  return (
    <div className="bg-[#f70003] content-stretch flex items-center px-[24px] py-[12px] relative rounded-[9999px] shrink-0" data-name="Button - 5. Create Wallet">
      <div className="absolute bg-[rgba(255,255,255,0)] inset-0 rounded-[9999px] shadow-[0px_10px_15px_-3px_rgba(0,0,0,0.1),0px_4px_6px_-4px_rgba(0,0,0,0.1)]" data-name="Button - 5. Create Wallet:shadow" />
      <Container33 />
      <Margin />
    </div>
  );
  ...
  return (
    <div className="relative shrink-0 size-[20px]" data-name="SVG">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20 20">
        <g id="SVG">
          <path d={svgPaths.p2bdc3dc0} id="Vector" stroke="var(--stroke-0, white)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.66667" />
        </g>
      </svg>
    </div>
  );
...
function Container35() {
  return (
    <div className="content-stretch flex flex-col items-center relative shrink-0" data-name="Container">
      <div className="[word-break:break-word] flex flex-col font-['Public_Sans:SemiBold',sans-serif] font-semibold justify-center leading-[0] relative shrink-0 text-[14px] text-center text-white whitespace-nowrap">
        <p className="leading-[20px]">View Transactions</p>
      </div>
    </div>
  );
}
...
function Button4ViewTransactions() {
  return (
    <div className="bg-[#f70003] content-stretch flex items-center px-[24px] py-[12px] relative rounded-[9999px] shrink-0" data-name="Button - 4. View Transactions">
      <div className="absolute bg-[rgba(255,255,255,0)] inset-0 rounded-[9999px] shadow-[0px_10px_15px_-3px_rgba(0,0,0,0.1),0px_4px_6px_-4px_rgba(0,0,0,0.1)]" data-name="Button - 4. View Transactions:shadow" />
      <Svg1 />
      <Margin1 />
    </div>
  );
...
function Button4ViewTransactionsMargin() {
  return (
    <div className="content-stretch flex flex-col items-start pt-[16px] relative shrink-0" data-name="Button - 4. View Transactions:margin">
      <Button4ViewTransactions />
    </div>
  );
}
  ...
  return (
    <div className="relative shrink-0 size-[18px]" data-name="Container">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 18 18">
        <g id="Container">
          <path d={svgPaths.p38493f00} fill="var(--fill-0, white)" id="Icon" />
        </g>
      </svg>
    </div>
  );
...
function Container37() {
  return (
    <div className="content-stretch flex flex-col items-center relative shrink-0" data-name="Container">
      <div className="[word-break:break-word] flex flex-col font-['Public_Sans:SemiBold',sans-serif] font-semibold justify-center leading-[0] relative shrink-0 text-[14px] text-center text-white whitespace-nowrap">
        <p className="leading-[20px]">Purchase Units</p>
      </div>
    </div>
  );
}
...
function Button3PurchaseUnits() {
  return (
    <div className="bg-[#f70003] content-stretch flex items-center px-[24px] py-[12px] relative rounded-[9999px] shrink-0" data-name="Button - 3. Purchase Units">
      <div className="absolute bg-[rgba(255,255,255,0)] inset-0 rounded-[9999px] shadow-[0px_10px_15px_-3px_rgba(0,0,0,0.1),0px_4px_6px_-4px_rgba(0,0,0,0.1)]" data-name="Button - 3. Purchase Units:shadow" />
      <Container36 />
      <Margin2 />
    </div>
  );
...
function Button3PurchaseUnitsMargin() {
  return (
    <div className="content-stretch flex flex-col items-start pt-[16px] relative shrink-0" data-name="Button - 3. Purchase Units:margin">
      <Button3PurchaseUnits />
    </div>
  );
}
...
function Svg2() {
  return (
    <div className="relative shrink-0 size-[20px]" data-name="SVG">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20 20">
        <g id="SVG">
          <path d={svgPaths.p3e9f3298} id="Vector" stroke="var(--stroke-0, white)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.66667" />
        </g>
      </svg>
    </div>
  );
...
function Container38() {
  return (
    <div className="content-stretch flex flex-col items-center relative shrink-0" data-name="Container">
      <div className="[word-break:break-word] flex flex-col font-['Public_Sans:SemiBold',sans-serif] font-semibold justify-center leading-[0] relative shrink-0 text-[14px] text-center text-white whitespace-nowrap">
        <p className="leading-[20px]">Process Pending Transaction</p>
      </div>
    </div>
  );
}
...
function Button2ProcessPendingTransaction() {
  return (
    <div className="bg-[#f70003] content-stretch flex items-center px-[24px] py-[12px] relative rounded-[9999px] shrink-0" data-name="Button - 2. Process Pending Transaction">
      <div className="absolute bg-[rgba(255,255,255,0)] inset-0 rounded-[9999px] shadow-[0px_10px_15px_-3px_rgba(0,0,0,0.1),0px_4px_6px_-4px_rgba(0,0,0,0.1)]" data-name="Button - 2. Process Pending Transaction:shadow" />
      <Svg2 />
      <Margin3 />
    </div>
  );
...
function Button2ProcessPendingTransactionMargin() {
  return (
    <div className="content-stretch flex flex-col items-start pt-[16px] relative shrink-0" data-name="Button - 2. Process Pending Transaction:margin">
      <Button2ProcessPendingTransaction />
    </div>
  );
}

function QuickActionButtonsStack() {
  return (
    <div className="content-stretch flex flex-col items-end relative shrink-0" data-name="Quick Action Buttons Stack">
      <Button5CreateWallet />
      <Button4ViewTransactionsMargin />
      <Button3PurchaseUnitsMargin />
      <Button2ProcessPendingTransactionMargin />
    </div>
  );
}

function QuickActionButtonsStackMargin() {
  return (
    <div className="absolute content-stretch flex flex-col items-start left-[calc(25%+35px)] pb-[16px] top-[666px]" data-name="Quick Action Buttons Stack:margin">
      <QuickActionButtonsStack />
    </div>
  );
}
...
export default function QuickMenu() {
  return (
    <div className="bg-[#f7f6f8] relative size-full" data-name="Quick Menu">
      <StatusbarIPhoneXLightBackground />
      <Header />
      <Main />
      <div className="absolute backdrop-blur-[4px] bg-[rgba(25,28,30,0.4)] inset-0" data-name="Overlay+OverlayBlur" />
      <FloatingButton />
      <QuickActionButtonsStackMargin />
    </div>
  );
}